...
<head>
    ...
    <link rel="icon" href="{{ asset('img/logos/fav.png') }}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@200;300;500;700;800&family=Padauk:wght@400;700&display=swap" rel="stylesheet">
...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom position-fixed top-0 w-100">
    <div class="container">
        <a class="navbar-brand" href="{{ route('index') }}">
            <img src="{{ asset('img/logos/logo.PNG') }}" style="height: 40px" class="me-1" alt="">
        </a>
                ...
                <div class="mb-5 sidebar">
                    <div id="search" class="mb-5">
                        <form action="" method="get">
                            <div class="d-flex search-box">
                                <input type="text" name="search" value="{{ request()->search }}" class="form-control flex-shrink-1 me-2 search-input" placeholder="Search Anything" required>
                    ...
                    <div id="category" class="mb-5">
                        ...
                        <ul class="list-group">
                            ...
                            @empty
                            <li class="list-group-item">
                                <a href="#" class="disabled">There is No Category Yet</a>
                            </li>
                            @endforelse
                        </ul>
                    </div>
